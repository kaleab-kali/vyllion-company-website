...
export default function AboutPage() {
  ...
  return (
    <>
      <Head>
        <link rel="canonical" href="https://vyllion.com/about" />
      </Head>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  ...
                  },
                  {
                    ...
                    role: "Head of Design",
                    description:
                      "Crafting elegant digital experiences that blend beauty and functionality for premium brands.",
                  },
                  {
                    name: "David Kim",
                    role: "Lead Software Engineer",
                    description:
                      "Building robust, scalable systems that power our clients' success in the digital age.",
                  },
                ].map((member, index) => (
                  <Card key={index} className="bg-slate-900/50 border border-yellow-400/30 hover:border-yellow-400/50 transition-all duration-300">
                    <CardContent className="p-6 text-center">
